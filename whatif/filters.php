<?php
	...
	$filter_out = "<ul class='filter-cats'>";
		$filter_out .= "
			...
			<a title='" . __('Restablecer','whatif') . "' href='$home/vistas/mensajes'><img src='$template_url/images/reset.png' style='width:30px;' alt='" . __('Restablecer','whatif') . "' /></a>
			...
			<a title='" . __('Mensajes positivos','whatif') . "' href='$home/vistas/mensajes?pn=positivo&pn2=$pn2'><img src='$template_url/images/$plvaria' alt='" . __('Mensajes positivos','whatif') . "' /></a>
			<div class='filter-tit'><a href=''></a></div>
			</li>
			<li id='tax-negativo' class='filter-cat'>
			<a title='" . __('Mensajes negativos','whatif') . "' href='$home/vistas/mensajes?pn=negativo&pn2=$pn2'><img src='$template_url/images/$mnvaria' alt='" . __('Mensajes negativos','whatif') . "' /></a>
			<div class='filter-tit'><a href=''></a></div>
			</li>
	...
	foreach ( get_categories("exclude=1&hide_empty=0") as $categ ) {
		...
		$filter_out .= "
			...
			<div class='filter-tit'><a href='$home/vistas/mensajes?filtro=$categoryID&pn=$pn2'>$categ->category_count</a></div>
			</li>
		";
