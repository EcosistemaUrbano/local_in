...
if ( $count2 == 1) { $valor_query .= "$term->slug"; }
	...
	$filter_out = "<ul class='filter-cats'>";
		$filter_out .= "
			...
			<a title='" . __('Restablecer','whatif') . "' href='" .WHATIF_BLOGURL. "/vistas/localizaciones'><img src='" .WHATIF_BLOGTHEME. "/images/reset.png' style='width:30px;' alt='" . __('Restablecer','whatif') . "' /></a>
			...
			<a title='" . __('Mensajes positivos','whatif') . "' href='" .WHATIF_BLOGURL. "/vistas/localizaciones?pn=positivo&pn2=$pn2'><img src='" .WHATIF_BLOGTHEME. "/images/$plvaria' alt='" . __('Mensajes positivos','whatif') . "' /></a>
			<div class='filter-tit'><a href=''></a></div>
			</li>
			<li id='tax-negativo' class='filter-cat ' >
			<a title='" . __('Mensajes negativos','whatif') . "' href='" .WHATIF_BLOGURL. "/vistas/localizaciones?pn=negativo&pn2=$pn2'><img src='" .WHATIF_BLOGTHEME. "/images/$mnvaria' alt='" . __('Mensajes negativos','whatif') . "' /></a>
			<div class='filter-tit'><a href=''></a></div>
			</li>
	...
	foreach ( get_categories("exclude=1&hide_empty=0") as $categ ) {
		...
		$filter_out .= "
			...
			<a href='" .WHATIF_BLOGURL. "/vistas/localizaciones?filtro=$categoryID&pn=$pn2' >$categImg</a>
			</div>
